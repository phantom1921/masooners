...
class ProSubCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        // dd($proSubCategories);
        return view('admin.proSubCategories.index', compact('proSubCategories'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.proSubCategories.create', compact('prof_categories'));
    }
    ...
    public function store(StoreProSubCategoryRequest $request)
    {
        ...
        return redirect()->route('admin.pro-sub-categories.index');
    }
    ...
    public function edit(ProSubCategory $proSubCategory)
    {
        ...
        return view('admin.proSubCategories.edit', compact('prof_categories', 'proSubCategory'));
    }
    ...
    public function show(ProSubCategory $proSubCategory)
    {
        ...
        return view('admin.proSubCategories.show', compact('proSubCategory'));
    }
