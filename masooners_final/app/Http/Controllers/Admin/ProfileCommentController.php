...
class ProfileCommentController extends Controller
{
    public function index()
    {
        ...
        return view('admin.profileComments.index', compact('profileComments'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.profileComments.create');
    }
    ...
    public function edit(ProfileComment $profileComment)
    {
        ...
        return view('admin.profileComments.edit', compact('profileComment'));
    }
    ...
    public function show(ProfileComment $profileComment)
    {
        ...
        return view('admin.profileComments.show', compact('profileComment'));
    }
