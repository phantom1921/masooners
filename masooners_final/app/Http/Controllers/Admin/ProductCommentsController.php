...
class ProductCommentsController extends Controller
{
    public function index()
    {
        ...
        return view('admin.productComments.index', compact('productComments'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.productComments.create');
    }
    ...
    public function edit(ProductComment $productComment)
    {
        ...
        return view('admin.productComments.edit', compact('productComment'));
    }
    ...
    public function show(ProductComment $productComment)
    {
        ...
        return view('admin.productComments.show', compact('productComment'));
    }
