...
class ProductStylesController extends Controller
{
    public function index()
    {
        ...
        return view('admin.productStyles.index', compact('productStyles'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.productStyles.create');
    }
    ...
    public function store(StoreProductStyleRequest $request)
    {
        ...
        return redirect()->route('admin.product-styles.index');
    }
    ...
    public function edit(ProductStyle $productStyle)
    {
        ...
        return view('admin.productStyles.edit', compact('productStyle'));
    }
    ...
    public function show(ProductStyle $productStyle)
    {
        ...
        return view('admin.productStyles.show', compact('productStyle'));
    }
