...
class ProfessionalProfileController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.professionalProfiles.index', compact('professionalProfiles'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.professionalProfiles.create', compact('users'));
    }
    ...
    public function store(StoreProfessionalProfileRequest $request)
    {
        ...
        return redirect()->route('admin.professional-profiles.index');
    }
    ...
    public function edit(ProfessionalProfile $professionalProfile)
    {
        ...
        return view('admin.professionalProfiles.edit', compact('users', 'professionalProfile'));
    }
    ...
    public function show(ProfessionalProfile $professionalProfile)
    {
        ...
        return view('admin.professionalProfiles.show', compact('professionalProfile'));
    }
