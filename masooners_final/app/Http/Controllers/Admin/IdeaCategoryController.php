...
class IdeaCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.ideaCategories.index', compact('ideaCategories'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.ideaCategories.create');
    }
    ...
    public function store(StoreIdeaCategoryRequest $request)
    {
        ...
        return redirect()->route('admin.idea-categories.index');
    }
    ...
    public function edit(IdeaCategory $ideaCategory)
    {
        ...
        return view('admin.ideaCategories.edit', compact('ideaCategory'));
    }
    ...
    public function show(IdeaCategory $ideaCategory)
    {
        ...
        return view('admin.ideaCategories.show', compact('ideaCategory'));
    }
