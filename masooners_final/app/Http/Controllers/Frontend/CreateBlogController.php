...
class CreateBlogController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.createBlogs.index', compact('createBlogs'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.createBlogs.create', compact('categories'));
    }
    ...
    public function store(StoreCreateBlogRequest $request)
    {
        ...
        return redirect()->route('frontend.create-blogs.index');
    }
    ...
    public function edit(CreateBlog $createBlog)
    {
        ...
        return view('frontend.createBlogs.edit', compact('categories', 'createBlog'));
    }
    ...
    public function show(CreateBlog $createBlog)
    {
        ...
        return view('frontend.createBlogs.show', compact('createBlog'));
    }
