...
class ProfessionalDetailsController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.professionalDetails.index', compact('professionalDetails'));
    }
    ...
    public function edit(ProfessionalDetail $professionalDetail)
    {
        ...
        return view('frontend.professionalDetails.edit', compact('categories', 'users', 'professionalDetail'));
    }
    ...
    public function show(ProfessionalDetail $professionalDetail)
    {
        ...
        return view('frontend.professionalDetails.show', compact('professionalDetail'));
    }
