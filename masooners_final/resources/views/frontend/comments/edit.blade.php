                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.comments.update", [$comment->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="user_type" id="user_type" value="{{ old('user_type', $comment->user_type) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="user" id="user" value="{{ old('user', $comment->user) }}" required>
                            @if($errors->has('user'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('user') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="comment" id="comment" required>{{ old('comment', $comment->comment) }}</textarea>
