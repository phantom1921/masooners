            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.product-categories.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="required" for="category_image">{{ trans('cruds.productCategory.fields.category_image') }}</label>
                            <div class="needsclick dropzone" id="category_image-dropzone">
                            </div>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.productCategory.fields.category_image_helper') }}</span>
                        </div>
                        <div class="form-group">
...
<script>
    ...
    init: function () {
@if(isset($productCategory) && $productCategory->category_image)
      var file = {!! json_encode($productCategory->category_image) !!}
