                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.orders.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="order_no" id="order_no" value="{{ old('order_no', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="total_bill" id="total_bill" value="{{ old('total_bill', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="customer" id="customer" value="{{ old('customer', '') }}">
