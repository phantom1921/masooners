    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.wishlists.update", [$wishlist->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="product">{{ trans('cruds.wishlist.fields.product') }}</label>
                            <input class="form-control" type="text" name="product" id="product" value="{{ old('product', $wishlist->product) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="customerid" id="customerid" value="{{ old('customerid', $wishlist->customerid) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="customer_type" id="customer_type" value="{{ old('customer_type', $wishlist->customer_type) }}">
