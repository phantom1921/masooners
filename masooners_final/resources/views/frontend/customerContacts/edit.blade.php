    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.customer-contacts.update", [$customerContact->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="city">{{ trans('cruds.customerContact.fields.city') }}</label>
                            <input class="form-control" type="text" name="city" id="city" value="{{ old('city', $customerContact->city) }}" required>
                            @if($errors->has('city'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="country" id="country" value="{{ old('country', $customerContact->country) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="state" id="state" value="{{ old('state', $customerContact->state) }}" required>
                            @if($errors->has('state'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('state') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="number" id="number" value="{{ old('number', $customerContact->number) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="zip" id="zip" value="{{ old('zip', $customerContact->zip) }}" required>
                            @if($errors->has('zip'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('zip') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="address" id="address" required>{{ old('address', $customerContact->address) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="address_2" id="address_2">{{ old('address_2', $customerContact->address_2) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="customerid" id="customerid" value="{{ old('customerid', $customerContact->customerid) }}">
