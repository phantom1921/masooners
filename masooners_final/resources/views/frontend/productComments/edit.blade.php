    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.product-comments.update", [$productComment->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="user_type">{{ trans('cruds.productComment.fields.user_type') }}</label>
                            <input class="form-control" type="text" name="user_type" id="user_type" value="{{ old('user_type', $productComment->user_type) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="user" id="user" value="{{ old('user', $productComment->user) }}" required>
                            @if($errors->has('user'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('user') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="comment" id="comment" value="{{ old('comment', $productComment->comment) }}" required>
