    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.customer-logins.update", [$customerLogin->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="email">{{ trans('cruds.customerLogin.fields.email') }}</label>
                            <input class="form-control" type="text" name="email" id="email" value="{{ old('email', $customerLogin->email) }}" required>
                            @if($errors->has('email'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="password" id="password" value="{{ old('password', $customerLogin->password) }}">
