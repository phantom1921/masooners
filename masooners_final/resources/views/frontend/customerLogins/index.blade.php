        ...
        <div class="col-md-12">
            @can('customer_login_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.customer-logins.create') }}">
                                    ...
                                    <tr data-entry-id="{{ $customerLogin->id }}">
                                        ...
                                        <td>
                                            @can('customer_login_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.customer-logins.show', $customerLogin->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('customer_login_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.customer-logins.edit', $customerLogin->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('customer_login_delete')
                                                <form action="{{ route('frontend.customer-logins.destroy', $customerLogin->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('customer_login_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.customer-logins.massDestroy') }}",
