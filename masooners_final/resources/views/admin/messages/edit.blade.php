    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.messages.update", [$message->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('message') ? 'is-invalid' : '' }}" name="message" id="message">{{ old('message', $message->message) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('userid') ? 'is-invalid' : '' }}" type="text" name="userid" id="userid" value="{{ old('userid', $message->userid) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customerid') ? 'is-invalid' : '' }}" type="text" name="customerid" id="customerid" value="{{ old('customerid', $message->customerid) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('flow') ? 'is-invalid' : '' }}" type="text" name="flow" id="flow" value="{{ old('flow', $message->flow) }}">
                @if($errors->has('flow'))
                    <div class="invalid-feedback">
                        {{ $errors->first('flow') }}
                    </div>
