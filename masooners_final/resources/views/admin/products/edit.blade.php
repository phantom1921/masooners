...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="discription">{{ trans('cruds.product.fields.discription') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('discription') ? 'is-invalid' : '' }}" name="discription" id="discription">{!! old('discription', $product->discription) !!}</textarea>
                @if($errors->has('discription'))
                    <div class="invalid-feedback">
                        {{ $errors->first('discription') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.product.fields.discription_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('approved') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="approved" id="approved" value="1" {{ $product->approved || old('approved', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="approved">{{ trans('cruds.product.fields.approved') }}</label>
                </div>
