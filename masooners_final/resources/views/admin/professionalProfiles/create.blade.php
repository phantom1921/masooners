...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.professional-profiles.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('pro_about') ? 'is-invalid' : '' }}" name="pro_about" id="pro_about">{!! old('pro_about') !!}</textarea>
